...
#AutoIt3Wrapper_Icon=NFSMW_icon.ico
#AutoIt3Wrapper_Outfile=NFSMW_Launcher.exe
#AutoIt3Wrapper_Compression=4
#AutoIt3Wrapper_UseUpx=n
#AutoIt3Wrapper_UPX_Parameters=-9 --strip-relocs=0 --compress-exports=0 --compress-icons=0
#AutoIt3Wrapper_Res_Description=Need for Speed™ Most Wanted Widescreen Launcher
...
#pragma compile(FileDescription, 'Need for Speed™ Most Wanted Widescreen Launcher')
#pragma compile(FileVersion, 1.0.0.47)
#pragma compile(InternalName, 'Need for Speed™ Most Wanted Widescreen Launcher')
#pragma compile(LegalCopyright, '2016, SalFisher47')
#pragma compile(OriginalFilename, NFSMW_Launcher.exe)
#pragma compile(ProductName, 'Need for Speed™ Most Wanted Widescreen Launcher')
#pragma compile(ProductVersion, 1.0.0.47)
#EndRegion ;**** Pragma Compile ****
; === NFSMW_launcher.au3 ===========================================================================================================
; Title .........: Need for Speed™ Most Wanted Launcher
; Version .......: 1.0.0.47
; AutoIt Version : 3.3.14.5
; Language ......: English
; Description ...: Need for Speed™ Most Wanted Widescreen Launcher
;				   - based on ThirteenAG's widescreen fix
; Author(s) .....: SalFisher47
; Last Modified .: December 26, 2016
; ==================================================================================================================================
$exe32bit = @ScriptDir & "\Speed.exe"
$widescreen_fix_ini = @ScriptDir & "\scripts\NFSMostWanted.WidescreenFix.ini"
$widescreen_fix_asi = @ScriptDir & "\scripts\NFSMostWanted.WidescreenFix.asi"
...
FileInstall("NFSMW_ProgramData.ini", @AppDataCommonDir & "\SalFisher47\WidescreenLauncher\NFSMW.ini", 0)
$cracked_ProgramData = IniRead(@AppDataCommonDir & "\SalFisher47\WidescreenLauncher\NFSMW.ini", "EXE", "cracked", 0)
#ce
If Not FileExists($exe32bit) Then
	MsgBox(16, "Need for Speed™ Most Wanted Launcher", "Executable not found:" & @CRLF & "..\Speed.exe")
	Exit
EndIf
Switch $desktopRatio
	Case 1.33   ; 4:3 aspect ratio, 1024x768
		If not FileExists($widescreen_fix_ini) Then
			...
			FileInstall("scripts\NFSMostWanted.WidescreenFix.ini", $widescreen_fix_ini, 0)
			FileInstall("scripts\NFSMostWanted.WidescreenFix.asi", $widescreen_fix_asi, 0)
...
Func _Cracked()
	If $cracked == 1 Then
		...
		Else
			...
			IniWrite(@AppDataCommonDir & "\SalFisher47\WidescreenLauncher\NFSMW.ini", "EXE", "cracked", " 1")
		EndIf
	Else
		FileInstall("Speed.exe", @ScriptDir & "\Speed.exe", 1)
		IniWrite($widescreen_fix_ini, "EXE", "cracked", " 1")
